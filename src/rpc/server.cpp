...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop HashShareCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "HashShareCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HashShareCoin features */
        {"hashsharecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"hashsharecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hashsharecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hashsharecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"hashsharecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"hashsharecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"hashsharecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hashsharecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"hashsharecoin", "startmasternode", &startmasternode, true, true, false},
        {"hashsharecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hashsharecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hashsharecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hashsharecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hashsharecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hashsharecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hashsharecoin", "preparebudget", &preparebudget, true, true, false},
        {"hashsharecoin", "submitbudget", &submitbudget, true, true, false},
        {"hashsharecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hashsharecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hashsharecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hashsharecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hashsharecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hashsharecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hashsharecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hashsharecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"hashsharecoin", "mnsync", &mnsync, true, true, false},
        {"hashsharecoin", "spork", &spork, true, true, false},
        {"hashsharecoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> hashsharecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15113/\n";
}
