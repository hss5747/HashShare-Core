...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HashShare Coin hashsharecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hashsharecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hashsharecoin transaction") + "\n" +
                               "  hashsharecoin-tx [options] -create [commands]   " + _("Create hex-encoded hashsharecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hashsharecoin transaction
