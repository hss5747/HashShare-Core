...
#include "key.h"
#include "zhss/accumulatorcheckpoints.h"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzHSSWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZHSS(denom, coin, dMint);
