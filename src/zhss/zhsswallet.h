...
#ifndef HashShareCoin_ZHSSWALLET_H
#define HashShareCoin_ZHSSWALLET_H
...
public:
    CzHSSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHSS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHSS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //HashShareCoin_ZHSSWALLET_H
