...
#ifndef HashShareCoin_ZHSSTRACKER_H
#define HashShareCoin_ZHSSTRACKER_H
...
public:
    CzHSSTracker(std::string strWalletFile);
    ~CzHSSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzHSSWallet* zHSSWallet = NULL);
...
#endif //HashShareCoin_ZHSSTRACKER_H
