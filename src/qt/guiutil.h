...
/** Utility functions used by the HashShareCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render HashShareCoin addresses in monospace font
...
// Parse "hashsharecoin:" URI into recipient object, return true on successful parsing
