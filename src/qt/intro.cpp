...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HashShare Coin"),
     ...
     * override -datadir in the hashsharecoin.conf file in the default data directory
     * (to be consistent with hashsharecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
