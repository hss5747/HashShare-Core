...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("HashShare Coin");
	...
	QString copyrightTextHashShareCoin = QChar(0xA9) + QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The HashShareCoin developers"));
    ...
    pixPaint.setPen(QColor(13, 138, 220));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextHashShareCoin);
...
static void InitMessage(SplashScreen* splash, const std::string& message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(13, 138, 220)));
}
