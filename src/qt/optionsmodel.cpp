...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::HSS);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeHashShareCoinAmount"))
        SoftSetArg("-anonymizehashsharecoinamount", settings.value("nAnonymizeHashShareCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in hashsharecoin.cpp during shotdown to also remove the window positions
