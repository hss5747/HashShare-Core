                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHSSPathCustom = GetArg("-zhssbackuppath", "");
    ...
    if(!strzHSSPathCustom.empty()) {
        ui->wallet_customzhssbackuppath->setText(QString::fromStdString(strzHSSPathCustom));
        ui->wallet_customzhssbackuppath_label->setVisible(true);
        ui->wallet_customzhssbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHSSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the HashShareCoin RPC console.") + "<br>" +
