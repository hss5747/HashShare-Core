...
public:
    ...
    void setZHssControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzHSS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzHSS_clicked();
    void on_pushButtonZHssControl_clicked();
