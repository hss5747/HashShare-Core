...
/* HashShareCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HashShareCoin"
#define QAPP_ORG_DOMAIN "hashsharecoin.org"
#define QAPP_APP_NAME_DEFAULT "HashShareCoin-Qt"
#define QAPP_APP_NAME_TESTNET "HashShareCoin-Qt-testnet"
