Contributing to HashShare Coin
============================

The HashShare Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/hashsharecoin-project/hashsharecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the HashShare Coin project, and is not to be
confused with overall HashShareCoin Network Protocol consensus changes.

Whether a pull request is merged into HashShare Coin rests with the project merge
...
Patches that change HashShareCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the HashShareCoin consensus, it must have been
...
The project leader is the release manager for each HashShare Coin release.
