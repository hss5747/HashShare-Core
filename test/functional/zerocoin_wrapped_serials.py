...
from fake_stake.base_test import HashShareCoin_FakeStakeTest

class zHSSwrappedSerialsTest(HashShareCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zHSSs..." % DENOM_TO_USE)
